  ...
  return (
    ...
    >
      ...
      <div className="container max-w-(--breakpoint-2xl) mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              A comprehensive hub for AI-assisted development rules and
              guidelines, enhancing your coding workflow.
            </p>
          </div>
          <div>
        ...
        >
          <p className="mb-2">
            &copy; {new Date().getFullYear()} VIbeKit VDK. All rights reserved.
          </p>
