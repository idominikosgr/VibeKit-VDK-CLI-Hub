    ...
    <div className="container max-w-6xl mx-auto py-8 px-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Create and submit new coding rules, patterns, and guidelines that can help other developers improve their AI-assisted workflows.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Contribute to our documentation, write tutorials, or help translate content.
            </p>
            <Button asChild variant="outline" className="w-full">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <p>
          The heart of our platform is the community-contributed rules. You can contribute by:
        </p>
        <ul>
          <li>Creating new coding rules for specific technologies or frameworks</li>
        ...
        <p>
          Help improve the platform itself by contributing code:
        </p>
        <ul>
        ...
        <p>
          Help make our platform more accessible:
        </p>
        <ul>
        ...
        <ul>
          <li><strong>Quality:</strong> Ensure your rules are well-tested and documented</li>
          <li><strong>Clarity:</strong> Write clear, understandable descriptions and examples</li>
          <li><strong>Originality:</strong> Don't duplicate existing rules without adding value</li>
          <li><strong>Attribution:</strong> Credit sources and inspirations appropriately</li>
          <li><strong>Respect:</strong> Be respectful and constructive in all interactions</li>
        </ul>

        <h2>Recognition</h2>
        <p>
          We value all contributions to our platform. Contributors are recognized through:
        </p>
        <ul>
