...
export const metadata: Metadata = {
  title: "Terms of Service | VibeKit VDK Hub",
  description:
    "Terms of service for VibeKit VDK Hub - your rights and responsibilities when using our platform.",
};
...
export default function TermsPage() {
  return (
    <LegalPageLayout
      ...
      description="By using VibeKit VDK Hub, you agree to these terms and conditions. Please read them carefully."
      icon="documentation"
      lastUpdated={new Date().toLocaleDateString()}
    >
      <LegalSection title="Acceptance of Terms" icon="check" highlight>
        <p>
          By accessing and using VibeKit VDK Hub, you accept and agree to be
      ...
      <LegalSection title="Description of Service" icon="code">
        <p>
          VibeKit VDK Hub is a platform that provides AI-assisted development
          rules and guidelines to enhance coding workflows. Our service
          includes:
        </p>
        <ul>
      ...
      <LegalSection title="Content and Intellectual Property" icon="folder">
        <p>
          You retain ownership of the content you create and upload to our
          platform. By using our service, you grant us a license to store,
          display, and distribute your content as necessary to provide our
          services.
        </p>
        <p>
          Our platform content, including rules, documentation, and software, is
          protected by intellectual property laws. Some content is made
      ...
      <LegalSection title="Service Availability" icon="settings">
        <p>
          ...
          guarantee uninterrupted access. We may temporarily suspend the service
      ...
      >
        <p>
          In no event shall VibeKit VDK Hub be liable for any indirect,
