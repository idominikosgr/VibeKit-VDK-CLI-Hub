...
const documentationPages = [
  {
    ...
    excerpt:
      "Learn how to set up and start using VibeKit VDK Hub for your AI-powered development workflow.",
    icon: "🚀",
    order: 0,
  },
  {
    ...
    excerpt:
      "Complete guide to installing and configuring VibeKit VDK Hub for development and production.",
    icon: "⚙️",
    order: 1,
  },
  {
    ...
    slug: "user-guide",
    excerpt:
      "Comprehensive guide covering all features and workflows in VibeKit VDK Hub.",
    icon: "📚",
    order: 2,
  },
  {
    ...
    excerpt:
      "Technical overview of the modern, scalable architecture with AI-first principles.",
    icon: "🏗️",
    order: 3,
  },
  {
    ...
    excerpt:
      "Guide to building autonomous AI systems that demonstrate agency and proactive behavior.",
    icon: "🤖",
    order: 4,
  },
  {
    ...
    excerpt:
      "Integrate AI agents with VibeKit VDK Hub for enhanced development workflows.",
    icon: "🔗",
    order: 5,
  },
  {
    ...
    excerpt:
      "Design and implement knowledge graphs for AI systems to maintain rich contextual understanding.",
    icon: "🧠",
    order: 6,
  },
  {
    ...
    excerpt:
      "Patterns and techniques for implementing sequential reasoning in AI systems.",
    icon: "🔄",
    order: 7,
  },
];
