...
const VibeCodeDemo = () => {
  ...
  const steps = [
    ...
    {
      title: "VDK Toolkit Power",
      code: `🚀 Want systematic intelligence?\n📡 curl -fsSL cli.vdk.tools | sh\n🧠 Context-aware rule generation\n⚡ Enterprise-ready automation`,
      description: "VibeKit VDK toolkit for teams",
    },
  ];
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6 relative">
        <div className="flex items-center gap-2">
          ...
          <div className="text-gray-400 text-sm ml-4 font-mono backdrop-blur-sm">
            vdk
          </div>
        </div>
        <button
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-0 bg-gradient-to-br opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-xl",
            gradient
          )}
        />
        ...
        <CardHeader className="pb-4 relative">
          ...
          <CardTitle className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-primary transition-colors duration-300 drop-shadow-sm">
            {title}
          </CardTitle>
        ...
        >
          <div className="max-w-7xl mx-auto text-center space-y-8">
            ...
            >
              ...
              >
                Transform your AI assistant into a{" "}
                <span className="text-primary font-bold">
                  project-aware coding genius
                </span>{" "}
                with systematic intelligence. Browse curated expert rules or
                deploy our automated toolkit for
                <span className="text-primary font-bold">
                  {" "}
            ...
            >
              <motion.div variants={fadeInUp} className="space-y-8">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Our platform reads your coding vibe, understands your stack,
                  and generates the perfect ruleset that makes your AI assistant
                  work like a senior developer on your team.
                </p>
                <div className="flex gap-6">
                  <Link href="/generate">
                    <Button className="hover:scale-105 transition-transform text-lg px-8 py-4">
                      Try the VibeKit Rule Generator
                    </Button>
                  </Link>
                  <Button
                    variant="ghost"
          ...
          <div className="max-w-7xl mx-auto relative">
            ...
            >
              ...
              <p className="text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Enterprise-grade rule sets that turn your AI assistant into a
                senior developer. Get code reviews, architecture guidance, and
            ...
            <div className="grid lg:grid-cols-3 gap-10">
              ...
              <VibeFeatureCard
                ...
                demo={
                  <div className="space-y-3">
                    {["GitHub Actions", "GitLab CI", "Jenkins", "CircleCI"].map(
                      (platform, i) => (
                        <motion.div
                          key={platform}
        ...
        <section className="py-32 px-6 relative">
          ...
          <div className="max-w-7xl mx-auto relative">
            ...
            >
              ...
              <p className="text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Perfect for weekend warriors, indie hackers, and creative
                coders. Get AI assistance that understands your experimental
                style and helps you learn faster.
              </p>
            </motion.div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-500">
                      ...
                      <div className="text-sm text-blue-700 dark:text-blue-300">
                        Consider useMemo for this calculation
                      </div>
                    </div>
                  </div>
                }
              ...
              <VibeFeatureCard
                ...
                demo={
                  <div className="grid grid-cols-2 gap-2">
                    {["Game Dev", "Art Gen", "Web App", "Bot"].map(
                      (template, i) => (
                        <motion.div
                          key={template}
          ...
          <div className="max-w-7xl mx-auto relative">
            ...
            >
              ...
              <p className="text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                ...
                VibeKit VDK provides 51+ specialized task rules, comprehensive
                language support, and automated setup that transforms any AI
                assistant into a project-aware coding expert with memory
                management and cross-session continuity.
              </p>
            </motion.div>
              ...
              >
                <div className="space-y-6">
                  <h3 className="text-3xl font-bold">
                    Context as Code. Intelligence as Structure.
                  </h3>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    VibeKit VDK bridges the gap between generic AI assistance
                    and project-specific intelligence. Our systematic approach
                    employs advanced static analysis to understand your
                    technology stack, naming patterns, and project
                    architecture—then automatically generates the context your
                    AI needs to work like a senior developer on your team.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Automatically identifies React, Vue, Django, Next.js,
                        and 50+ frameworks, libraries, and tools in your
                        codebase
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Deep analysis of your coding patterns, naming
                        conventions, and project structure to create
                        contextually perfect rules
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Works with Claude, GitHub Copilot, Cursor, Windsurf, VS
                        Code extensions, and any AI coding assistant
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="bg-gray-900 dark:bg-gray-950 rounded-2xl p-6 shadow-2xl border border-gray-800">
                  ...
                  <div className="font-mono text-sm space-y-2">
                    ...
                    <div className="text-gray-300">
                      ⚡ Generating context-aware rule toolkit...
                    </div>
                    <div className="text-gray-300">
              ...
              <motion.div variants={fadeInUp}>
                <Card className="h-full bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-emerald-200 dark:border-emerald-800/30 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Comprehensive task system including AI Session Handoff,
                      Code Quality Review, API Documentation, Accessibility
                      Review, and 47+ other specialized behaviors for
              ...
              <motion.div variants={fadeInUp}>
                <Card className="h-full bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-blue-200 dark:border-blue-800/30 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Advanced memory management and cross-session handoff
                      protocols ensure your AI assistant maintains project
                      context and coding patterns across development sessions
              ...
              <motion.div variants={fadeInUp}>
                <Card className="h-full bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-purple-200 dark:border-purple-800/30 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Works seamlessly with Cursor, VS Code, WebStorm, GitHub
                      Copilot, Claude, and any AI assistant. Interactive Rule
                      Generator automatically configures rules for your specific
                      technology stack.
                    </CardDescription>
                  </CardHeader>
                </Card>
            ...
            >
              <div className="inline-flex items-center gap-4 p-6 rounded-2xl bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-950/20 dark:to-blue-950/20 border border-emerald-200 dark:border-emerald-800/30">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Get the VibeKit VDK toolkit and make your AI assistant
                    project-aware in minutes
                  </p>
                </div>
                <Button
                  variant="outline"
                ...
                >
                  <a
                    href="https://github.com/idominikosgr/Vibe-Coding-Rules"
                    target="_blank"
        ...
        <section className="py-32 px-6 relative">
          ...
          <div className="max-w-5xl mx-auto text-center relative">
            ...
            >
              ...
              >
                Join thousands of developers who've already upgraded their AI
                assistants. From weekend projects to production apps, we've got
                the perfect vibe for your code.
              </motion.p>
