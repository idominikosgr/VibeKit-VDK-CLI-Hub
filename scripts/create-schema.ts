...
/**
 * This script creates the necessary database schema for the VibeKit VDK Hub app
 */

// Set environment variables directly
process.env.NEXT_PUBLIC_SUPABASE_URL =
  "https://izdtuhiciejisavhpqey.supabase.co";
process.env.NEXT_SUPABASE_SERVICE_ROLE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml6ZHR1aGljaWVqaXNhdmhwcWV5Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0Nzc0OTM3MSwiZXhwIjoyMDYzMzI1MzcxfQ.5GLsldY_6yW35to3NowChJqoof-09jUoB8n_lx8Hujw";
...
async function createSchema() {
  ...
  console.log(
    `Key: ${
      process.env.NEXT_SUPABASE_SERVICE_ROLE_KEY ? "Set (hidden)" : "Not Set"
    }`
  );
